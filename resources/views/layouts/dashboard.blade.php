            ...
            <div class="col-md-4">
                <div class="panel panel-inverse" data-sortable-id="index-6">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Single View </h4>
                    </div>
                    <div class="panel-body p-t-0">
                        <table class="table table-valign-middle m-b-0">
                            ...
                            <tbody>
                                <tr>
                                    <td><label class="label label-danger">GTBank</label></td>
                                    <td>1234567890 <span class="text-success"></span></td>
                                    <td>13,203,905 <span class="text-success"><i class="fa fa-arrow-up"></i></span></td>
                                    <!-- <td><div id="sparkline-unique-visitor"></div></td> -->
                                </tr>
                                <tr>
                                    <td><label class="label label-warning">Access Bank</label></td>
                                    <td>1234567890 <span class="text-success"></span></td>
                                    <td>1,230,030</td>
                                    <!-- <td><div id="sparkline-bounce-rate"></div></td> -->
                                </tr>
                                <tr>
                                    <td><label class="label label-success">First Bank</label></td>
                                    <td>1234567890 <span class="text-success"></span></td>
                                    <td>1,230,030</td>
                                    <!-- <td><div id="sparkline-total-page-views"></div></td> -->
                                </tr>
                                <tr>
                                    <td><label class="label label-primary">Zenith Bank</label></td>
                                    <td>1234567890 <span class="text-success"></span></td>
                                    <td>1,230,030</td>
                                    <!-- <td><div id="sparkline-avg-time-on-site"></div></td> -->
                                </tr>
                                <tr>
                                    <td><label class="label label-warning">Echo bank</label></td>
                                    <td>1234567890 <span class="text-success"></span></td>
                                    <td>1,230,030</td>
                                    <!-- <td><div id="sparkline-new-visits"></div></td> -->
                                </tr>
                                <tr>
                                    <td><label class="label label-inverse">UBA</label></td>
                                    <td>1234567890 <span class="text-success"></span></td>
                                    <td>1,230,030</td>
