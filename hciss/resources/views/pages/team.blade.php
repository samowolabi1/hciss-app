...
@section('content')
   <div class="banner">
    ...
    <div class="container mt-5">
      <div class="card">
        <h1 class="main-text text-dark text-header card-header">About Us</h1>
        <div class="card-body">
          <h5 class="card-title">About HCISS</h5>
          <p class="card-text text-justify text-dark"> Health Blockchain Security Services (HCISS) is specialized in blockchain cybersecurity analytics and provides advanced analytics to clients in the FinTech industry and other businesses that revolve around the blockchain ecosystem.
          </p>

        </div>
      </div>
    </div>
    <div class="container about-section position-relative mb-5" id="history">
      <div class="row mt-10" >
          <div class="col-md-6">
            <div class="image-div">
...
<div class="container" id="vision">
    <div class="row mt-n10" >
        <div class="col-md-6">
          ...
          <div class="card">
            <h1 class="main-text text-dark text-header card-header">Vision of HCISS</h1>
            <div class="card-body">
              <h5 class="card-title">Special title treatment</h5>
              <p class="card-text text-justify text-dark"> Our vision at HCISS is to be the “best in class” for providing Blockchain Security Analytics as a Service (BSECAaaS) to individuals and organizations whose businesses revolve around the blockchain ecosystem.</p>
...
<!-- APPLY FOR A DEMO -->
<section class="demo-application mt-10 bg-dark pt-5 pb-5">
  <header class="container">
    ...
    <p class="text-center"> <a href="#" class="btn btn-outline-primary rounded-0 text-center">APPLY NOW</a></p>
  </header>
</section>
...
<section class="footer-section" style="background-color: #2e4469">
  ...
  <div class="footer-clean">
    ...
    <img src="./images/hciss_logo.png" class="logo" alt=""><span class="text-header h3">| We are the Future</span>
  </div>
