...
<div class="container-contact100">
  <div class="wrap-contact100">
    ...
    <form action="{{route('demo.request')}}" method="POST" class="contact100-form validate-form">
     ...
     <div class="wrap-input100 validate-input">
        <select name="industry" class="input100 form-control" style="color: #999999">
          <option value="Select State of Origin">Select Industry</option>
          ...
          <option value="pharmaciticals">pharmaceuticals</option>
